...
class MeviusEnv:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False):
        ...
        for name in self.env_cfg["joint_names"]:
            ...
            # Convert to local DOF index
            local_dof_idx = joint.dof_start - self.robot._dof_start
            self.motors_dof_idx.append(local_dof_idx)
    ...
    def step(self, actions):
        ...
        ) * 180.0 / torch.pi  # Convert to degrees
